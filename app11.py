...
class AudiogramApp(ctk.CTk):
    def __init__(self):
        ...
        self.calibration_options = [
            ctk.CTkRadioButton(self.calibration_frame, text="Default", variable=self.calibration_var, value="Opcja 1"),
            ctk.CTkRadioButton(self.calibration_frame, text="Ear 3A", variable=self.calibration_var, value="Opcja 2"),
            ctk.CTkRadioButton(self.calibration_frame, text="TDH 39", variable=self.calibration_var, value="Opcja 3"),
            ctk.CTkRadioButton(self.calibration_frame, text="Biological", variable=self.calibration_var, value="Opcja 4"),
        ]
        ...
        self.start_button = ctk.CTkButton(self.bottom_frame, text="Start", command=self.updateAudiogram)
    ...
    def updateAudiogram(self):
        ...
        self.after(1000, self.updateAudiogram)
        ...
        if file_path:
            try:
                with open(file_path, mode='r', encoding='utf-8') as csvfile:
                    ...
                    if len(audiogram_data['Left Ear']) == len(self.frequencies) and \
                            len(audiogram_data['Right Ear']) == len(self.frequencies):
